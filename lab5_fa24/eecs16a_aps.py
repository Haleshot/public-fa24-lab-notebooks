...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""**<span style="color:red">If `beacon2` arrives 450 samples later than `beacon0`, what is the *time* difference of arrival (in seconds) given that our sampling rate is $f_s=44100$ Hz?</span>**  <br><br> **Hint: the formula $T = \frac{1}{f}$ will be useful**, where T and f are defined above.""")
    return
...
@app.cell
def _(identify_offsets, test_identify_offsets):
...
@app.cell
def _(offsets_to_tdoas, test_offsets_to_tdoas):
...
@app.cell
def _(signal_to_tdoas, test_signal_to_tdoas):
